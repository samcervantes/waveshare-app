...
// {photos, bluetooth}, page 6 = {stack, stocks}, page 7 = {hn}. (rgb is
// skipped on the touch board, which has no NeoPixel; whack is touch board
// only, since it needs tap position.)
